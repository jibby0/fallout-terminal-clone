...
#define DEFAULT_WORDARR_SIZE 6915
...
void readFile(FILE* fp){
    ...
    if(fp == NULL) {
        ...
        /* Return a default array of words */
        ...
        wordArr = malloc(DEFAULT_WORDARR_SIZE);

        for(int i=0; i<DEFAULT_WORDARR_SIZE; i++) {
            *(wordArr+i) = malloc(sizeof(char) * DEFAULT_WORD_LENGTH);
            strcpy(*(wordArr+i), defaultWords[i]);
        }
